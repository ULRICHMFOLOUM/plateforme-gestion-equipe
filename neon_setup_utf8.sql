...
-- CreateEnum
CREATE TYPE "GroupRole" AS ENUM ('OWNER', 'MANAGER', 'CONTRIBUTOR', 'VIEWER', 'ADMIN', 'MEMBER');

-- CreateEnum
CREATE TYPE "RoomType" AS ENUM ('DIRECT', 'GROUP');

-- CreateEnum
CREATE TYPE "ReportType" AS ENUM ('ACTIVITY', 'PERFORMANCE', 'FINANCIAL', 'TASKS', 'TEAM', 'FULL', 'PROGRESS', 'BUDGET');

-- CreateEnum
CREATE TYPE "ConferenceStatus" AS ENUM ('SCHEDULED', 'ONGOING', 'COMPLETED', 'CANCELLED');
...
-- CreateEnum
CREATE TYPE "NotificationType" AS ENUM ('CONTACT_REQUEST', 'CONTACT_ACCEPTED', 'PROJECT_INVITE', 'TASK_ASSIGNED', 'TASK_COMPLETED', 'GENERAL');
...
-- AddForeignKey
ALTER TABLE "VideoConference" ADD CONSTRAINT "VideoConference_projectId_fkey" FOREIGN KEY ("projectId") REFERENCES "Project"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "VideoConference" ADD CONSTRAINT "VideoConference_hostId_fkey" FOREIGN KEY ("hostId") REFERENCES "User"("id") ON DELETE CASCADE ON UPDATE CASCADE;
